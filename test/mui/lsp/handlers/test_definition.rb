...
class TestDefinitionHandler < Minitest::Test
  def setup
    @editor = MockEditor.new
    @client = MockClient.new
    @handler = Mui::Lsp::Handlers::Definition.new(editor: @editor, client: @client)
  end

  class TestHandleResult < TestDefinitionHandler
    ...
    def test_handle_result_with_location_link
      result = [
        {
          "targetUri" => "file:///path/to/target.rb",
          "targetRange" => {
      ...
      # Should jump to selection range
      refute @editor.scratch_buffer_opened
    ...
    def test_handle_result_with_empty_result
      ...
      assert_equal "No definition found", @editor.message
    end
    ...
    def test_stores_locations_for_picker
      ...
      assert_equal :definition, @editor.instance_variable_get(:@lsp_picker_type)
    end
  end

  class TestHandleError < TestDefinitionHandler
